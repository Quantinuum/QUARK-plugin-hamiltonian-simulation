...
def trotterStep(
    u: list, qubits: list, dt: float, eps: float, omega: float, parity: int, N: int
):
...
def initial_state_prep(
    u: list, qubits: list, filled: bool, mode: str, spare: bool, N: int
):
